...
export const initiateBooking = async (showId, seatIds, userId = localStorage.getItem('user_id') || 'user-123') => {
...
export const revertBooking = async (bookingId) => {
  const res = await fetch(`${API_BASE}/bookings/${bookingId}/revert`, {
    method: 'POST',
  });
...
export const listTheatersByAdmin = async (adminId) => {
  const res = await fetch(`${API_BASE}/admin/theaters?admin_id=${adminId}`);
...
export const deleteTheater = async (id) => {
  const res = await fetch(`${API_BASE}/admin/theaters/${id}`, { method: 'DELETE' });
...
export const addScreen = async (theaterId, data) => {
  const res = await fetch(`${API_BASE}/admin/theaters/${theaterId}/screens`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export const getScreens = async (theaterId) => {
  const res = await fetch(`${API_BASE}/theaters/${theaterId}/screens`);
...
export const updateScreen = async (screenId, data) => {
  const res = await fetch(`${API_BASE}/admin/screens/${screenId}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export const deleteScreen = async (theaterId, screenId) => {
  const res = await fetch(`${API_BASE}/admin/theaters/${theaterId}/screens/${screenId}`, { method: 'DELETE' });
...
export const addSeat = async (screenId, data) => {
  const res = await fetch(`${API_BASE}/admin/screens/${screenId}/seats`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export const getSeats = async (screenId) => {
  const res = await fetch(`${API_BASE}/screens/${screenId}/seats`);
  if (!res.ok) throw new Error('Failed to get seats');
  return res.json();
};

export const updateSeat = async (seatId, data) => {
  const res = await fetch(`${API_BASE}/admin/seats/${seatId}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
  });
...
export const deleteSeat = async (screenId, seatId) => {
  const res = await fetch(`${API_BASE}/admin/screens/${screenId}/seats/${seatId}`, { method: 'DELETE' });
...
export const deleteMovie = async (id) => {
  const res = await fetch(`${API_BASE}/admin/movies/${id}`, { method: 'DELETE' });
...
export const getShowsByTheater = async (theaterId) => {
  const res = await fetch(`${API_BASE}/theaters/${theaterId}/shows`);
...
export const deleteShow = async (id) => {
  const res = await fetch(`${API_BASE}/admin/shows/${id}`, { method: 'DELETE' });
